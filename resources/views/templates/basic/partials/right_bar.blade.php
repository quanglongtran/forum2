...
@guest
    <div class="rounded-3 bg--gradient p-4 text-center mb-4">
        <h3 class="fw-normal text-white">@lang('THAM GIA DIỄN ĐÀN')</h3>
        <p class="text-white fs--14px mt-3">{{ __(@$register->data_values->text) }}</p>
        <a href="{{ route('user.register') }}" class="btn btn--base mt-4">@lang('Đăng ký')</a>
    </div>
@endguest

  <div class="sidebar-widget">
    <div class="sidebar-widget__header">
      <h5 class="sidebar-widget__title">@lang('Thống kê')</h5>
    </div>
    <div class="sidebar-widget__body">
      <ul class="statistics-list">
        <li class="single-stat">
            <h3 class="single-stat__number">{{ $forum }}</h3>
            <span class="single-stat__caption fs--14px">@lang('Diễn đàn')</span>
        </li>
        <li class="single-stat">
          <h3 class="single-stat__number">{{ $category }}</h3>
          <span class="single-stat__caption fs--14px">@lang('Danh mục')</span>
        </li>
        <li class="single-stat">
          <h3 class="single-stat__number">{{ $subCategory }}</h3>
          <span class="single-stat__caption fs--14px">@lang('Chủ đề')</span>
        </li>
        <li class="single-stat">
            <h3 class="single-stat__number">{{ $post }}</h3>
            <span class="single-stat__caption fs--14px">@lang('Bài viết')</span>
        </li>
      </ul>
    </div>
  ...
  <div class="sidebar-widget mt-4">
    <div class="sidebar-widget__header">
      <h5 class="sidebar-widget__title">@lang('Đóng góp nhiều nhất')</h5>
    </div>
    <div class="sidebar-widget__body">
  ...
  <div class="sidebar-widget mt-4">
    <div class="sidebar-widget__header">
      <h5 class="sidebar-widget__title">@lang('Chưa có thảo luận')</h5>
    </div>
    <div class="sidebar-widget__body">
  ...
  <div class="sidebar-widget mt-4">
    <div class="sidebar-widget__header">
      <h5 class="sidebar-widget__title">@lang('Chủ đề nổi bật')</h5>
    </div>
    <div class="sidebar-widget__body">
      <ul class="topic-list">
      @foreach($hots as $hot)
