...
Route::get('user/topics/{username}/{id}','SiteController@userTopics')->name('user.topics');
Route::get('user/answered/{username}/{id}','SiteController@userAnswer')->name('user.answer');
Route::get('user/up-vote/{username}/{id}','SiteController@userUpVote')->name('user.up.vote');
Route::get('user/down-vote/{username}/{id}','SiteController@userDownVote')->name('user.down.vote');

Route::get('ad-redirect/{hash}','SiteController@adRedirect')->name('adRedirect');
Route::get('ad-count-ajax','SiteController@adCountAjax')->name('ad.count.ajax');
...
Route::get('topic/details/{slug}/{id}','SiteController@postDetails')->name('post.details');
Route::post('load/more/comments', 'SiteController@moreComment')->name('more.comment');

Route::get('search', 'SiteController@search')->name('search');
Route::get('all/topics', 'SiteController@allPost')->name('post.all');
...
Route::get('/old-page', function() {return 123;})->name('old');
...
Route::name('forum.')->prefix('forum')->group(function() {
    ...
    Route::get('view-test', [SiteController::class, 'viewTest'])->name('view-test');
    Route::get('post/{slug}/{id}', [SiteController::class, 'post_news']);
    Route::get('category/{slug}/{id}', [SiteController::class, 'subCatNews']);
    Route::post('like', [SiteController::class, 'like'])->name('like');
    Route::post('reply', [SiteController::class, 'reply'])->name('reply');
    Route::get('get-reply', [SiteController::class, 'getReply'])->name('get-reply');
});
