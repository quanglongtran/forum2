      ...
      <div class="container-fluid">
        <nav class="navbar navbar-expand-xl p-0 align-items-center">
          ...
          <form class="header-search-form header-search-form-mobile" action="{{ route('search') }}">
            <input type="text" name="title" placeholder="@lang('Tìm kiếm theo tiêu đề')..." class="header-search-form__input text-white">
          ...
          <div class="collapse navbar-collapse mt-lg-0 mt-3" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav main-menu ms-auto">
              ...
              <li><a href="{{ route('post.all') }}">@lang('Chủ đề')</a></li>
            ...
            <div class="nav-right">
              ...
              @else
                <a href="{{ route('user.login') }}" class="btn btn-md btn--gradient d-flex align-items-center"><i class="las la-user fs--18px me-2"></i>@lang('Đăng nhập')</a>
              @endauth
            </div>
          </div>
        </nav>
