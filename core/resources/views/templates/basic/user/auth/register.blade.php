                            ...
                            <h3 class="mb-3">@lang('Perosnal Information')</h3>
                              <div class="form-group">
                                ...
                                <div class="custom-icon-field">
                                  ...
                                  <input id="firstname" type="text" class="form--control" name="firstname" value="{{ (old('firstname')) ? old('firstname') : 'Long' }}" required>
                                </div>
                              </div>
                              <div class="form-group">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-icon-field hover-input-popup">
                                  ...
                                  <input id="password" type="password" class="form--control" value="long123!@#aA" name="password" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-icon-field">
                                  <i class="las la-key"></i>
                                  <input id="password-confirm" type="password" class="form--control" value="long123!@#aA" name="password_confirmation" required autocomplete="new-password">
                                </div>
                            </div>
                          </div>
                        </div>
