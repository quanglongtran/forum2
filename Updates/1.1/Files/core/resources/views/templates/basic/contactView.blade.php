...
@section('content')
		<div class="container mt-10">
			<div class="row justify-content-center">
				<div class="col-xl-12 mt-xl-0 mt-5">
			        <div class="card">
			            <div class="sidebar-widget__header d-flex justify-content-between">
			                <h5 class="sidebar-widget__title">
			                    &nbsp;
			                ...
			                @if($my_ticket->status != 3)
			                    <button class="btn btn-danger btn-sm close-button" type="button" title="@lang('Close Ticket')" data-bs-toggle="modal" data-bs-target="#DelModal"><i class="fa fa-times"></i>
			                    </button>
			                @endif
			                                        ...
			                                        <div class="row justify-content-between">
			                                            <div class="col-md-8">
			                                                <div class="row justify-content-between">
			                                                    ...
			                                                    <div class="col-md-1">
			                                                        <div class="form-group">
			                                                            <a href="javascript:void(0)" class="btn bg-primary btn-sm btn-round mt-5 addFile">
			                                            ...
			                                            <div class="col-md-3">
			                                                <button type="submit" class="btn bg-primary mt-4">
            ...
            <div class="modal-content">
                <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn bg-primary btn-sm"><i class="fa fa-check"></i> @lang("Confirm")
                        </button>
                    </div>
                </form>
            </div>
                ...
                $("#fileUploadsContainer").append(
                    `<div class="input-group">
                        ...
                        <div class="input-group-append support-input-group">
                            <span class="input-group-text btn btn-sm btn-danger mt-4 support-btn remove-btn">x</span>
                        </div>
                    </div>`
                )
            });
